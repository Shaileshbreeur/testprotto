...
$result_insert =  mysqli_query($conn, $sql_1);
 ...
 $sql_3 = "SELECT * FROM `bike_customer` bc INNER join pro_vip pv on pv.bike_rto = bc.bike_reg WHERE bc.cust_id = '$cust_id'";
...
<?php $counter = 1;
while($rb = mysqli_fetch_assoc($result_bike)) {
    echo $counter;
    // echo $rb['bike_reg'];
     ?>
...
<input type="radio" name="bike"  value="
<?php echo $rb['make'].'//'.$rb['model'].'//'.$cust_id; ?>">
<?php echo $rb['bike_reg']; ?>
<?php echo  $rb['make'].'-('.$rb['model'].')' ; ?>


<?php

$result_provip =  mysqli_query($conn, $sql_3);
while($provip123 = mysqli_fetch_assoc($result_provip)) {
   if($provip123['bike_rto'] == $rb['bike_reg']){

    $cust_id =$provip123['cust_id'];
    $registeration =$provip123['bike_reg'];
    $provip =$provip123['prowet']+$provip123['prodry_wet'];
    $dataprowet =$provip123['prowet'];
    $dataprodry =$provip123['prodry_wet'];

?>

<button class="prowetdry_availbuton" customer_id = '<?php echo $provip123['cust_id'] ?>' registeration = '<?php echo $provip123['bike_reg'] ?>' provip = '<?php echo $provip123['prowet']+$provip123['prodry_wet']; ?>' dataprowet = '<?php echo $provip123['prowet']; ?>' dataprodry = ' <?php echo $provip123['prodry_wet'] ?>'> pro wet : <?php echo $provip123['prowet']; ?>  prodry : <?php echo $provip123['prodry_wet'] ?> </button><br/>
...
$counter++;
 ...
 ?>
 <center><input type="radio" name="bike"  value="other">  Add bikes </center><br/>
</div>
...
echo "<div style='padding-top:10px;' class='form-group row modellist'><div class='col-md-3'></div><div class='col-md-2'><label for='make'>Brand:</label></div><div class='col-md-4'>";
...
echo "<div class='form-group row modellist' id='modellist'><div class='col-md-3'></div><div class='col-md-2'><label for='model'>Model:</label></div><div class='col-md-4'>";
...
echo "<div class='form-group    proviphide'>";
                                ...
                                <div class='col-sm-12 col-md-6 col-lg-6'>
                                    <div class='pricingtable-wrapper'>
                                        <div class='pricingtable-inner '>
                                            <div class='pricingtable-price'> <span class='pricingtable-bx' id='prodryprice' > </span> <span class='pricingtable-type' > Rs</span> </div>
                                            <div id='pricingtable-title'>
                                               <img src='images/ProDry.png' width='193' height='89' alt=''>
                                            </div>
                                            ...
                                            <div class='pricingtable-footer'> <a href='#couponsection' class='site-button' id='selectprodry1'>Add to Cart</a> </div>
                                        </div>
                                    </div>
                                </div>
                                <div class='col-sm-12 col-md-6 col-lg-6'>
                                    <div class='pricingtable-wrapper'>
                                        <div class='pricingtable-inner pricingtable-highlight'>
                                            <div class='pricingtable-price'> <span class='pricingtable-bx' id='prowetprice'></span> <span class='pricingtable-type'>Rs</span> </div>
                                            <div id='pricingtable-title'>
                                            <img src='images/ProWet.png' width='193' height='89' alt=''>
                                            </div>
                                            <ul class='pricingtable-features'>
                                                <li><i class='fa fa-check'></i> Full Responsive </li>
                                                <li><i class='fa fa-check'></i> Multi color theme</li>
...
echo "<div class='form-group row'><div class='col-md-3'></div><div class='col-md-2'><label for='name'>Name:</label></div><div class='col-md-4'><input id='name' name='name' type='text' placeholder='".$name."' value='".$name."' readonly class='form-control input-md' required=''></div> <div class='col-md-3'></div></div>";
echo"</br>";

echo "<div class='form-group row'><div class='col-md-3'></div>
...
echo "<div class='form-group row'><div class='col-md-3'></div>
<div class='col-md-2'><label for='address'>Pick-up Address</label> </div>
<div class='col-md-4'>
...
echo "<div class='form-group row'><div class='col-md-3'></div>
<div class='col-md-2'><label for='locality'>Locality:</label> </div>
<div class='col-md-4'>
...
echo "<div class='form-group row'><div class='col-md-3'></div>
<div class='col-md-2'><label for='date'>Booking Date</label> </div>
<div class='col-md-4'>
...
echo"</br>";
echo "<div class='form-group row'><div class='col-md-3'></div>
<div class='col-md-2 control-label' for='time'>Time</label> </div>
<div class='col-md-4'>
<select id='time' name='time' class='form-control'>
<option value='9am - 11am' id='9am'>9 AM - 11 AM</option>
<option value='11am - 1pm' id='11am'>11 AM - 1 PM</option>
<option value='1pm - 3pm' id='1am'>1 PM - 3 PM</option>
<option value='3pm - 5pm' id='3am'>3 PM - 5 PM</option>
</select>
</div><div class='col-md-3'></div>
</div>";
 ...
 echo"</br>";
echo "<div class='form-group row'><div class='col-md-3'></div>
<div class='col-md-2 control-label' for='regno'>Registration No.</label> </div>
<div class='col-md-4'>
...
echo"</br>";
echo "<div class='form-group row'><div class='col-md-3'></div>
<div class='col-md-4 control-label' for='rideable'>Is your bike rideable?<br /><small><strong>Note:</strong> One-way Pick-up Truck <a href='/mumbai/pricing.html'>charges</a> maybe charged extra.</small></label> </div>
<div class='col-md-2'>
...
echo"</br>";
echo "<div class='form-group row'><div class='col-md-3'></div>
<div class='col-md-2 control-label' for='note'>Special Request</label></div>
<div class='col-md-4'>
...
echo"</br>";
echo "<div class='form-group row proviphide'><div class='col-md-3'></div>
<div class='col-md-2 control-label' for='coupon'>Coupon Code<br /> </label></div>
<div class='col-md-4'>
<input id='coupon' name='coupon' type='text' placeholder='PRO123' class='form-control input-md' style='width: 65%; display: inline-block;' ><button class='btn' type='button' id='applycoupon'>Apply</button></div>
</div><div class='col-md-3'></div>
</div>";
...
echo "<input id='servicetype' name='servicetype' type='hidden' value='' >";

echo "<br /><span id='payblock1' style='display: none; float: right;'><strong>We are processing your request. Please do not reload.</strong></span><input name='paynow' id='paynowbtn1' style='float: right; margin-left: 50px;' type='submit' class='btn' value='Pay Now' /><input id='paylaterbtn1' name='paylater' style='float: right; background: #403a35!important;' type='submit' class='btn' value='Pay Later' />";
...
echo "<br /><span id='payblock2' style='display: none; float: right;'><strong>We are processing your request. Please do not reload.</strong></span><input id='paynowbtn2' name='paynow' style='float: right; margin-left: 50px;' type='submit' class='btn' value='Pay Now' /><input id='paylaterbtn2' name='paylater' style='float: right; background: #403a35!important;' type='submit' class='btn' value='Pay Later' />";
...
<div class="container provipshow" style="display:none">
  <div class="button-wrapper">
    <button id="prowet_btn" pval = '' value="prowet" customer_id = '' registeration = '' provip = '' dataprowet = '' dataprodry = '' >  </button>



    <button id="prodry_btn" pval = '' value="prodry" customer_id = '' registeration = '' provip = '' dataprowet = '' dataprodry = ' '  > </button>
  </div>
</div>


<button id="provip_checkout" customer_id='' registeration='' service= '' provip= ''  style="display:none"> book now  </button>
...
$.post('custom/checkcouponstatus.php',
   ...
   }else if(data == 'Coupon used already'){

    alert("Coupon used already");

$('#coupon').val('');

   }else if(data == 'Coupon code invalid'){
...
// $('input[type=radio][name=other]').change(function() {
...
$('.prowetdry_availbuton').click(function(){


$('#prowet_btn').attr('pval',$(this).attr("dataprowet"));
$('#prowet_btn').attr('customer_id',$(this).attr("customer_id"));
$('#prowet_btn').attr('registeration',$(this).attr("registeration"));
$('#prowet_btn').attr('dataprowet',$(this).attr("dataprowet"));
$('#prowet_btn').attr('dataprodry',$(this).attr("dataprodry"));
$('#prowet_btn').html ('pro wet '+ $(this).attr("dataprowet"));


$('#prodry_btn').attr('pval',$(this).attr("dataprodry"));
$('#prodry_btn').attr('customer_id',$(this).attr("customer_id"));
$('#prodry_btn').attr('registeration',$(this).attr("registeration"));
$('#prodry_btn').attr('dataprowet',$(this).attr("dataprowet"));
$('#prodry_btn').attr('dataprodry',$(this).attr("dataprodry"));
$('#prodry_btn').html('pro dry '+ $(this).attr("dataprodry"));
...
$('#prowet_btn').click(function(){

if($(this).attr("pval") == 0 ){

    alert('you cant avail this service ');
...
$('.proviphide').hide();
$('.provipshow').hide();
$('#provip_checkout').show();


$('#provip_checkout').attr('customer_id', $(this).attr("customer_id") );
$('#provip_checkout').attr('registeration', $(this).attr("registeration") );
$('#provip_checkout').attr('provip', $(this).attr("provip") );
$('#provip_checkout').attr('service', $(this).attr("value") );



  $('#regno').val($(this).attr("registeration"));
       $('#regno').attr('readonly', true);
...
$('#provip_checkout').click(function(){

var customer = $(this).attr("customer_id");
var registeration =$(this).attr("registeration");
var provip =$(this).attr("provip");
...
var model =$('#bike_model').val();
     ...
     $.ajax({
        type: "POST",
        url: 'custom/getprovipbooking.php',
         data : { 'customer' : customer, 'registeration' : registeration, 'provip' : provip,'service':service,'name': name ,'email':email,'phone':phone,'address':address,'locality':locality,'datepicker':datepicker,'time':time,'note':note,'make': make,'model':model},
        success: function(data) {


            if(data == 1){
  alert('success your bike is booked  .');
  location.reload();
...
if(String(output) == String(this.value)){
...
<?php
 ...
 $curr_time =  strtotime(date("h:i:sa"));



// if(trim($curr_time) =='12:31:00pm'){
if($curr_time <= strtotime("02:00:00pm")){


 ?>

    <script>
   $( "#datepicker" ).datepicker({  maxDate:'+31d',  dateFormat: 'dd/mm/yy', width: "255px",minDate: new Date()});
    </script>
...
<?php }else { ?>
    ...
    <script>
   $( "#datepicker" ).datepicker({  maxDate:'+31d',  dateFormat: 'dd/mm/yy', width: "255px",minDate: '+1d'});
    </script>
