...
echo "<div style='padding-top:10px;' class='form-group row'><div class='col-md-3'></div><div class='col-md-2'><label for='make'>Brand</label></div><div class='col-md-4'>";

echo "<select id='make' name='make' class='form-control'>" . $makeitems . "</select>";

echo "</div><div class='col-md-3'></div></div>";

echo "<div class='form-group row' id='modellist'><div class='col-md-3'></div><div class='col-md-2'><label for='model'>Model</label></div><div class='col-md-4'>";
...
<div class='col-md-4'><input id='name' name='name' type='text' placeholder='".$name."' value='".$name."' readonly class='form-control input-md' required=''></div>
