            ...
            <div class="container">
                ...
                <div class="row">
                   <div class="col-md-6 col-lg-3 m-b30">
                       <a style="all: none;" href="landing.php" class="brand"> <div class="icon-bx-wraper p-a20 text center">
                            <div class="icon-md text-primary m-b15"> <span class="icon-cell"><i class="ti-settings icon-3x"></i></span> </div>
...
<!--                                 <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod </p>
 -->                            </div>
                    ...
                    <div class="col-md-6 col-lg-3 m-b30">
                       <a style="all: none;" href="procleanse.php" class="brand" >  <div class="icon-bx-wraper p-a20  text center">
                            <div class="icon-md text-primary m-b15"> <span class="icon-cell"><i class="ti-headphone-alt icon-3x"></i></span> </div>
                            <div class="icon-content text-center">
...
<!--                                 <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod </p>
 -->                            </div>
                    ...
                    <div class="col-md-6 col-lg-3 m-b30">
                      <a style="all:none;" href="prorepair.php" class="brand">  <div class="icon-bx-wraper p-a20  text center">
                            <div class="icon-md text-primary m-b15"> <span class="icon-cell icon-4x"><i class="ti-bar-chart-alt"></i></span> </div>
                            <div class="icon-content text-center">
...
<!--                                 <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod </p>
 -->                            </div>
                    ...
                    <div class="col-md-6 col-lg-3 m-b30">
                           <a style="all: none;" href="provip.php"class="brand" >  <div class="icon-bx-wraper p-a20  text center">
                            <div class="icon-md text-primary m-b15"> <span class="icon-cell"><i class="ti-bar-chart-alt icon-3x"></i></span> </div>
                            <div class="icon-content text-center">
            ...
            <div class="container">
                <div class="row">
					...
					<div class="col-lg-4 col-md-4 text-center">
						<span> Design With <i class="ti-heart text-primary heart"></i> By PROTTO </span>
					</div>
